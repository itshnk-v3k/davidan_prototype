...
/// its page, toasts) plus a few quiet fades, the splash's one entrance and the
/// popular row's slow float, and changes everything else at once.
abstract final class AppMotion {
  ...
  /// The splash's entrance, once as the app opens: the logo settles in, then
  /// the tagline follows [fast] behind. Well inside the time the splash holds
